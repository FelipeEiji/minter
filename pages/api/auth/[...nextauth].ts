    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          const { id, address, profileId, expirationTime } = (await Moralis.Auth.verify({ message, signature, network: "evm" })).raw;

          const user = { id, address, profileId, expirationTime, signature };
